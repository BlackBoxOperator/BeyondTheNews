...
tokenFile = os.path.join('..', 'tokens', 'simple_search_wdict4_token.txt')
tokeyFile = os.path.join('..', 'tokens', 'simple_search_wdict4_tokey.txt')
queryDictFile = os.path.join('..', 'data', 'simple_wdict4.txt')
